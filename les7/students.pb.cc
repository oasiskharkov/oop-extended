...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_students_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::students::Student, grades_),
  PROTOBUF_FIELD_OFFSET(::students::Student, average_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::students::StudentsGroup, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::students::StudentsGroup, students_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::students::FullName)},
  { 8, -1, sizeof(::students::Student)},
  { 16, -1, sizeof(::students::StudentsGroup)},
};
...
const char descriptor_table_protodef_students_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "mic\030\003 \001(\t\"P\n\007Student\022$\n\010fullName\030\001 \001(\0132\022"
  ".students.FullName\022\016\n\006grades\030\002 \003(\005\022\017\n\007av"
  "erage\030\003 \001(\001\"4\n\rStudentsGroup\022#\n\010students"
  "\030\001 \003(\0132\021.students.Studentb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_students_2eproto = {
  false, false, 233, descriptor_table_protodef_students_2eproto, "students.proto", 
...
// @@protoc_insertion_point(generalized_merge_from_start:students.StudentsGroup)
  GOOGLE_DCHECK_NE(&from, this);
  const StudentsGroup* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<StudentsGroup>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:students.StudentsGroup)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:students.StudentsGroup)
    MergeFrom(*source);
  }
}
...
// @@protoc_insertion_point(generalized_copy_from_start:students.StudentsGroup)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
